  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加员工','${pageContext.request.contentType}/empl/add',600,400)"><i class="layui-icon"></i>添加</button>
