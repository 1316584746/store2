...
public class VerifyCodeServiceImpl implements VerifyCodeService {
    ...
    public boolean validate(String phoneNumber, String verifyCode) {
        //从Session中取出phoneNumber和 verifyCode
        VerifyCodeVO verifyCode1 = UserContext.getVerifyCode();

        if (verifyCode.equals(verifyCode1.getCode())&& phoneNumber.equals(verifyCode1.getPhoneNumber())){
          return  true;
        }else
        {
            return  false;
